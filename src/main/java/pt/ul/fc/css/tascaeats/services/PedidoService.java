...
public class PedidoService {
     ...
     *
     * Regras aplicadas:
     * - O restaurante deve estar aberto ({@code aberto = true}).
     ...
     * @param restauranteId   ID do restaurante ao qual o pedido é feito
     ...
     * @throws RuntimeException         se o cliente, restaurante ou algum produto
     *                                  não for encontrado
     * @throws IllegalStateException    se o restaurante estiver fechado ou algum
    ...
    /**
     * Lista todos os pedidos recebidos por um determinado restaurante,
    ...
    public List<Pedido> buscarPorRestaurante(Long restauranteId) {
        return pedidoRepository.findByRestauranteIdOrderByDataHoraDesc(restauranteId);
    }
