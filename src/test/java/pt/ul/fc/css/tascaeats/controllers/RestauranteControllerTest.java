...
class RestauranteControllerTest {
        ...
        void setUp() {
                ...
                restaurante = new Restaurante("Casa do Porto", endereco, "555666777",
                                "Portuguesa", LocalTime.of(12, 0), LocalTime.of(23, 0));
        ...
        void criar_Sucesso_Returns201() throws Exception {
                when(restauranteService.criarRestaurante(any(), any(), any(), any(), any(), any(), any()))
        ...
        void criar_NifDuplicado_Returns400() throws Exception {
                when(restauranteService.criarRestaurante(any(), any(), any(), any(), any(), any(), any()))
                                .thenThrow(new IllegalArgumentException(
                                                "Já existe um restaurante registado com este NIF"));
