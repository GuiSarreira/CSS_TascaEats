...
/**
 * Enumeração que representa os possíveis estados do ciclo de vida de uma
 * {@link Entrega}.
 *
 * Uma entrega é criada no estado {@code ATRIBUIDA} quando um {@link Entregador}
 * é associado a um pedido pago. O fluxo normal é:
